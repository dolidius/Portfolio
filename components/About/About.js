    ...
    <div id="about">
        <section className="about">
            ...
            <p className="about__info">
                I'm an 18 year old web developer from Poland who has a passion for front end technologies. I'm proficient with HTML5, CSS3, JavaScript with experience in React and NodeJS. If you want to see the projects that I have created, please visit my github/codepen.
            </p>
